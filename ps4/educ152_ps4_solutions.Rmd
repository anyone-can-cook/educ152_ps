...
- The coefficients for the model `cred_mod2_allcc` may be different from the model `cred_mod2` (sample of students who delayed at least one year) because students who delayed may find it helpful to take developmental courses to get them up to speed with college-level courses. On the other hand, students who start at a community college and take developmental courses may extend their time to degree and deter them from taking postsecondary courses (e.g., perhaps lose motivation). Additionally, the sample of students taken from both data frames are different and the relationship between the independent and dependent variables for both models could also be different.
