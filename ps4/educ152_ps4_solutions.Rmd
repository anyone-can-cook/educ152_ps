...
- The coefficients for the model `cred_mod2_allcc` may be different from the model `cred_mod2` (sample of students who delayed at least one year) because  the sample of students taken from both data frames are different and the relationship between the independent and dependent variables for both models is also different.
