...
#### 3. Using the values for ESS, SSR, and TSS from above, calculate $R^2$ in both ways discussed in lecture. Interpret the value of $R^2$ in words. 
...
#### 6. Interpret the SER from the above model in words. Interpret sample standard deviation from above model in words. Does our model make out prediction substantially better? 
