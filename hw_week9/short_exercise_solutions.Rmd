...
- $X_{1i}$ (parental income in \$ thousands); $\hat{\beta_1}=$ `r format(round(summary(mod1)$coefficients[2,1], digits =2),big.mark = ',')`
  - a one thousand dollar increase in parental income is associated with a `r format(round(summary(mod1)$coefficients[2,1], digits =2),big.mark = ',')` point change in high school reading test score.
- $X_{2i}$ (attends a Catholic private school); $\hat{\beta_2}=$ `r format(round(summary(mod1)$coefficients[3,1], digits =2),big.mark = ',')`
  - attending a Catholic private school as opposed to a public school is, on average, is associated with a `r format(round(summary(mod1)$coefficients[3,1], digits =2),big.mark = ',')` change in high school reading test score, holding the value of all other $X$ variables constant.
- $X_{3i}$ (attends a non-Catholic private school); $\hat{\beta_3}=$ `r format(round(summary(mod1)$coefficients[4,1], digits =2),big.mark = ',')`
  - attending a non-Catholic private school as opposed to a public school is, on average, is associated with a `r format(round(summary(mod1)$coefficients[4,1], digits =2),big.mark = ',')` change in high school reading test score, holding the value of all other $X$ variables constant.  
...
- $\hat{Y_i} =$ `r format(round(summary(mod1)$coefficients[1,1], digits =2),big.mark = ',')` + `r format(round(summary(mod1)$coefficients[2,1], digits =2),big.mark = ',')` $\times 150$ + `r format(round(summary(mod1)$coefficients[4,1], digits =2),big.mark = ',')` $\times 1=$ `r  round(summary(mod1)$coefficients[1,1], digits =2) + (round(summary(mod1)$coefficients[2,1], digits =2) * 150) + (round(summary(mod1)$coefficients[4,1], digits =2) * 1)`
