...
- where:
  ...
  - $\beta_1$ = population regression coefficient, which represents average effect of a one-unit increase in years of teacher experience $X$ on kindergarten student reading scores $Y$
